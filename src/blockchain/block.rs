...
impl BlockHeader {
    ...
    pub fn new(number: u64, parent_hash: H256, proposer: Address, gas_limit: U256) -> Self {
        Self {
            number,
            parent_hash,
...
impl Block {
    ...
    pub fn genesis() -> Self {
        let mut header =
            BlockHeader::new(0, H256::zero(), Address::zero(), U256::from(10_000_000u64));
